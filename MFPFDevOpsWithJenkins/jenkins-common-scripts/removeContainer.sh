...
{
   echo
   echo " Removes a MobileFirst Container from Bluemix Container"
   echo " -------------------------------------------------------------------------- "
   echo " This script removes MobileFirst Server/Analytics container running on Bluemix Container."
   echo
   echo " Silent Execution (arguments provided as command-line arguments) : "
   echo "   USAGE: removeContainer.sh <command-line arguments> "
