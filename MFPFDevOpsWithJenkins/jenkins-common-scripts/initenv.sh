...
JAR_DIR=$WORKSPACE/MFP_Container/jenkins-dependencies/lib

echo "Logging into IBM Bluemix Container Cloud Service.."
##PARSE_JAR=$PLUGIN_HOME/lib/json.jar
export CLASSPATH="$JAR_DIR/containerRESTCall.jar:$JAR_DIR/JSON4J.jar:$JAR_DIR/httpmime-4.5.jar:$JAR_DIR/commons-codec-1.9.jar:$JAR_DIR/commons-logging-1.2.jar:$JAR_DIR/httpclient-4.5.jar:$JAR_DIR/httpcore-4.4.1.jar"
